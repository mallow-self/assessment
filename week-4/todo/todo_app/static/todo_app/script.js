        ...
        .then(data => {
            ...
            data.todo.forEach(entry => {
                ...
                row.innerHTML = `
                            ...
                            <td>${entry.status}</td>
                            <td>
                                <button class="btn btn-primary btn-sm update-btn" onclick="update-todo(${entry.todo_id})">
                                ...
                                <button class="btn btn-danger btn-sm delete-btn" onclick="delete-todo(${entry.todo_id})">
                                <svg width="15px" height="15px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
